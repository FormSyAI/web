...
日期：2026-09-07 · 版本：v0.2 · 状态：交互演示已实现，真实服务待接入

目标：接通官网、注册登录、Coding Plan、模型 API 与企业能力，形成从了解产品、开通服务到持续使用的完整路径。本文件保留完整规划；本轮按用户确认交付可交互演示和接口预留，详见 [实现记录](CONSOLE_IMPLEMENTATION.md)。后台、计费和模型服务尚未上线。
...
- 保留现有登录注册界面与官网骨架，本轮交付本地交互演示，示例套餐可模拟开通，无法实际购买。
...
本方案作为官网结构的下一阶段扩展。本轮演示范围以实现记录为准；真实身份、支付、网关与企业模块仍待接入；生产文案、价格与模型权益以实际开放状态为准。
